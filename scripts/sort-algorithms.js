...
class sortAlgorithms {
    ...
    BubbleSort = async () => {
        ...
        // Update bar values after sorting
        for (let i = 0; i < this.size; i++) {
            const value = this.list[i].getAttribute("value");
            this.list[i].innerText = value; // Display the value in the bar
        }
    };
